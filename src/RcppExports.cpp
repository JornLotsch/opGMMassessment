...
RcppExport SEXP _opGMMassessment_findMatchingSeedsCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP verboseSEXP, SEXP progressEverySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _opGMMassessment_findMatchingSeedsBatchCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP batchSizeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type candidates(candidatesSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_opGMMassessment_findMatchingSeedsCpp", (DL_FUNC) &_opGMMassessment_findMatchingSeedsCpp, 4},
    {"_opGMMassessment_findMatchingSeedsBatchCpp", (DL_FUNC) &_opGMMassessment_findMatchingSeedsBatchCpp, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_opGMMassessment(DllInfo *dll) {
